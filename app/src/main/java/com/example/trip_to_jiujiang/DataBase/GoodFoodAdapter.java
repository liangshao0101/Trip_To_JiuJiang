...
//吕明骏
public class GoodFoodAdapter extends ArrayAdapter<GoodFood> {
    private int resourceId;

    public GoodFoodAdapter(Context context, int textViewResourceId, List<GoodFood> objects) {
        super(context, textViewResourceId, objects);
        resourceId = textViewResourceId;
    }
    @Override
    public View getView(int position, View convertView, ViewGroup parent){
        GoodFood goodFood=getItem(position);   //获取当前项的实例
